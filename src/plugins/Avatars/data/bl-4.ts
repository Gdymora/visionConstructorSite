...
<section class="bg-white py-[75px] dark:bg-dark">
  <div class="mx-auto px-4 sm:container">
    <div class="flex items-end justify-center space-x-2 sm:space-x-5">
      ...
      <div class="h-[38px] w-[38px] rounded-[15px]">
        <img
      ...
      <div class="h-[42px] w-[42px] rounded-[15px]">
        <img
      ...
      <div class="h-[52px] w-[52px] rounded-[15px]">
        <img
      ...
      <div class="h-20 w-20 rounded-[15px]">
        <img
