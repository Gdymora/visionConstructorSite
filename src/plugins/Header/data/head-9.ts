export const source = `  <div class="flex justify-center bg-blue-900 text-white">
<nav class="self-center w-full max-w-7xl">
    <div class="flex md:flex-row flex-col justify-between items-center md:items-start">
        ...
        <ul class="flex justify-center my-4 items-center text-sm md:text-[18px] font-bold md:px-10" data-header-menu>
            <!-- Available attributes:
                 data-menu-item: menu item -->
            <li class="hover:underline underline-offset-4 decoration-2 decoration-white py-2 rounded-lg px-2 md:px-5">
...
<div class="flex flex-col text-center justify-center items-center max-w-7xl text-white">
    ...
    <span class="underline underline-offset-2 text-white -mt-3"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span>
    ...
    <div class="space-x-3 mt-6 md:mt-4" data-social-links>
    ...
    <div class="flex mt-10 space-x-5">
        ...
        <button class="bg-white text-blue-600 px-6 py-2 hover:brightness-105 font-semibold" data-button="read-more">Read More</button>
...
/* const portfolioData = {
    ...
    buttons: [
        { text: "Read More", type: "read-more", style: "bg-white text-blue-600" },
