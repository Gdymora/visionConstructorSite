...
const sources = [
    {
        id: 'SectionColorSheme-1',
        class: '',
        label: a1s,
        content: st1,
        category: 'Section colorSheme',
    }, {
        id: 'SectionColorSheme-2',
        class: '',
        label: a1s,
        content: st2,
        category: 'Section colorSheme',
    }, {
        id: 'SectionColorSheme-3',
        class: '',
        label: a1s,
        content: st3,
        category: 'Section colorSheme',
    }, {
        id: 'SectionColorSheme-4',
        class: '',
        label: a1s,
        content: st4,
        category: 'Section colorSheme',
    }, {
        id: 'SectionColorSheme-5',
        class: '',
        label: a1s,
        content: st5,
        category: 'Section colorSheme',
    },, {
        id: 'SectionColorSheme-6',
        class: '',
        label: a1s,
        content: st6,
        category: 'Section colorSheme',
