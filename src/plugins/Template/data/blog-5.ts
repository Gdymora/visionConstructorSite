export const source = ` <header class="max-w-5xl mx-auto pt-5">
    ...
    <ul class="flex flex-wrap -mx-2 overflow-hidden">
        <li class="my-2 px-2 w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3">
            <a href="./article-details.html">
                <div class="mx-2 flex items-center justify-center bg-gray-300 bg-cover bg-center relative rounded overflow-hidden" style="height:400px; background-image:url(https://images.unsplash.com/photo-1535827841776-24afc1e255ac?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80)">
        ...
        <li class="my-2 px-2 w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3">
            <a href="./article-details.html">
                <div class="mx-2 flex items-center justify-center bg-gray-300 bg-cover bg-center relative rounded overflow-hidden" style="height:400px; background-image:url(https://images.unsplash.com/photo-1602199926649-2e5e447bab97?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80)">
                    <div class="absolute w-full h-full bg-black z-10 opacity-50"></div>
                    <div class="relative z-20 text-center p-5">
        ...
        <li class="my-2 px-2 w-full overflow-hidden md:w-1/3 lg:w-1/3 xl:w-1/3">
            <a href="./article-details.html">
                <div class="mx-2 flex items-center justify-center bg-gray-300 bg-cover bg-center relative rounded overflow-hidden" style="height:400px; background-image:url(https://images.unsplash.com/photo-1554679665-f5537f187268?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80)">
                    <div class="absolute w-full h-full bg-black z-10 opacity-50"></div>
                    <div class="relative z-20 text-center p-5">
        ...
        <div class="mr-2 md:mr-4 ml-2">
            ...
            <div class="flex flex-wrap overflow-hidden mb-10">
                <div class="w-1/2 overflow-hidden pr-2 md:pr-4">
                    <div>
                        <img class="w-full h-auto rounded" src="https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=340&q=80" alt="">
                        <h2 class="text-gray-900 font-thin font-serif text-xl my-5"><a href="./article-details.html">Do You Make These Simple Mistakes In Travel?</a></h2>
    ...
    <div class="w-full overflow-hidden md:w-2/6 lg:w-2/6 xl:w-2/6">
        ...
        <div class="ml-2 md:ml-4 mr-2">
            <div class="mt-20 sm:mt-0 text-center">
                ...
                <h2 class="font-light text-xl my-5">Raalhu</h2>
                <p class="text-gray-900 font-thin tracking-wider leading-loose">Hi! Welcome to Raalhu theme preview. Raalhu is a minimal blog theme built with tailwindcss. It is an html theme available free of change, with only a few page templates. Enjoy!</p>
            </div>
            <div class="mt-20">
