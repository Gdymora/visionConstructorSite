...
<div class="flex flex-wrap overflow-hidden">
    <div class="w-full overflow-hidden md:w-4/6 lg:w-4/6 xl:w-4/6">
        <div class="mr-2 md:mr-4 ml-2">
            <h2 class="font-semibold text-2xl mb-10"><a href="./article-details.html">Travel Tips</a><a href="./article-details.html" class="block text-sm italic font-light">View All →</a></h2>
            ...
            <h2 class="font-semibold text-2xl mb-10"><a href="">Destinations</a><a href="" class="block text-sm italic font-light">View All →</a></h2>
            <div class="flex flex-wrap overflow-hidden mb-10">
                <div class="w-1/2 overflow-hidden pr-2 md:pr-4">
                    <div>
        ...
        <div class="ml-2 md:ml-4 mr-2">
            ...
            <div class="mt-10">
                ...
                <ul>
                    ...
                    <li class="flex"><a href="" class="text-gray-900 font-thin font-serif text-lg py-2 block flex-1">Destinations</a><span class="text-gray-700 text-lg font-thin p-2">10</span></li>
