        ...
        <div class="mr-2 md:mr-4 ml-2">
            <div class="pb-10">
                ...
                <div>
                    ...
                    <h2 class="text-gray-900 font-serif text-3xl my-5 font-thin"><a href="">How To Make More Travel By Doing Less</a></h2>
                    <span class="text-xs text-gray-800 font-thin block mb-5">By Page. December 02, 2019</span>
                    <div class="text-gray-900 font-thin tracking-wider leading-loose">
                ...
                <ul>
                    ...
                    <li class="mb-3">
                        <a href="./article-details.html" class="flex">
                            <div class="w-1/3">
                                <img class="rounded" src="https://images.unsplash.com/photo-1469474968028-56623f02e42e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=340&q=80" alt="">
                            </div>
                            <div class="w-2/3 p-2">
