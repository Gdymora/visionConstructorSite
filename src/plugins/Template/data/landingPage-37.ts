...
<div class="relative pt-16 pb-32 flex content-center items-center justify-center" style="min-height: 75vh;">
  ...
  <div
    ...
    style="background: url(https://images.unsplash.com/photo-1614728263952-84ea256f9679?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1608&q=80);">
    <!-- Overlay -->
    <span id="blackOverlay" class="w-full h-full absolute opacity-75 bg-pink-200"></span>
  </div>
    ...
    <div class="items-center flex flex-wrap">
      <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
        <div class="pr-12">
          ...
          <p class="mt-4 text-lg text-black-300" data-aos="fade-right"
          data-aos-delay="1000">
    ...
    <div class="flex flex-wrap items-center mt-32">
      ...
      data-aos="flip-left" data-aos-delay="1000">
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-orange-500">
          ...
          <img
            alt="..."
            src="https://images.unsplash.com/photo-1680169269536-90d568e45600?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
    ...
    <div class="items-center flex flex-wrap">
      ...
      data-aos="flip-right" data-aos-delay="1000"> 
        ...
        <img
          ...
          src="https://plus.unsplash.com/premium_photo-1679954565372-6d0fed2bce02?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=678&q=80"
        />
      </div>
      <!-- Text Box Container-->
