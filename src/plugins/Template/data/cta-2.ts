export const source = `<div class="antialiased bg-gray-50 dark:bg-gray-900">
        ...
        <div class="flex justify-start items-center">
          ...
          <a href="https://flowbite.com" class="flex items-center justify-between mr-4">
            <img
              ...
              alt="Flowbite Logo"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CTA-2</span>
          </a>
