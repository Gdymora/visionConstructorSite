export const source = `  <!-- ====== Date Picker Start -->
<section class="bg-white py-20 dark:bg-dark">
  <div class="container">
    <div class="mx-auto max-w-[380px]">
      ...
      <div
        class="flex w-full flex-col rounded-lg border border-stroke bg-white px-4 py-6 shadow-xs sm:px-6 sm:py-[30px] dark:border-dark-3 dark:bg-dark-2"
      >
        ...
        <div
          class="flex justify-between pb-2 text-sm font-medium text-dark dark:text-white"
        >
